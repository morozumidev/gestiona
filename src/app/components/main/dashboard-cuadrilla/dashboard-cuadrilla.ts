...
@Component({
  selector: 'app-dashboard-cuadrilla',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './dashboard-cuadrilla.html',
  styleUrl: './dashboard-cuadrilla.scss',
})
export class DashboardCuadrilla {
  ...
  private filterCuadrilla = signal<Cuadrilla>(Cuadrilla.Sur);
